...
export const testCases = [
  {
    ...
    assertions: (projectPath) => {
      ...
      assert.ok(!fs.existsSync(path.join(projectPath, 'app')), 'app folder should not exist at root when using src');
      assert.ok(fs.existsSync(path.join(projectPath, 'src', 'app')), 'app folder should exist in src');
    },
  },
  {
  ...
  },
  {
    ...
    assertions: (projectPath) => {
      ...
      assert.ok(!fs.existsSync(path.join(projectPath, 'src', 'app')), 'app folder should not exist in src');
    },
  },
];
